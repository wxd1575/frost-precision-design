      ...
      <div className="container mx-auto flex items-center justify-between px-4">
        ...
        <Link to="/" className="flex items-center gap-2">
          <div className="flex flex-col leading-none">
            <span className="font-display text-2xl font-800 tracking-tight text-primary-foreground">
              FROST <span className="text-ice">/</span> ICE
            </span>
            <span className="font-body text-[10px] uppercase tracking-[0.25em] text-ice/70">
        ...
        <div className="hidden lg:flex items-center gap-8">
          {navLinks.map((link) => (
            <Link
              key={link.to}
              to={link.to}
              className={`font-display text-sm uppercase tracking-widest transition-colors duration-200 ${
          ...
          <a href="tel:+27845893702" className="flex items-center gap-2 text-frost/80 hover:text-ice transition-colors">
            <Phone className="h-4 w-4" />
            <span className="font-display text-sm tracking-wider">+27 84 589 3702</span>
          </a>
          <Link to="/contact">
